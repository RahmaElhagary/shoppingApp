              ...
              child: Center(
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        Text("Create Account",style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold,color: Color(0xff8E51FF)),),
                        Text("Join ShopCraft today",),
                        const SizedBox(height: 10,),
                        Align(alignment : Alignment.topLeft ,child: Text("Full name",style: TextStyle(fontWeight: FontWeight.bold),)),
                        TextFormField(
                          validator: (value){
                            if(value!.isEmpty){
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              onPressed: (){
                                setState(() {
                                  isObsucre2 = !isObsucre2;
                                });
                              },
                              icon: Icon(isObsucre2 ? Icons.visibility : Icons.visibility_off),
                            ),
                          ),
                        ),
                          ...
                          onPressed: (){
                            if(_formkey.currentState!.validate()){
                              showDialog(
                                ...
                                builder: (context){
                                  return AlertDialog(
                                    title: Center(child: Text("Success!",style: TextStyle(color: Color(0xff2AA63E),fontSize: 20.0,fontWeight: FontWeight.bold),)),
                                    content: Padding(
                                      padding: const EdgeInsets.all(10.0),
                                      child: Container(
